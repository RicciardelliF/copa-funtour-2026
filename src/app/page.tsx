  ...
  return (
    <div className="card space-y-6 text-center">
      ...
      <div className="rounded-2xl bg-amber-50 border border-amber-200 p-4 text-left space-y-2">
        ...
        <p className="text-sm text-amber-900">📍 Nos vemos a las 17:00 en la playa de Llevant — <a href="https://maps.app.goo.gl/Z3rGqkTMKz9NpZGG7" target="_blank" rel="noopener noreferrer" className="underline font-semibold text-amber-800">ubi del torneo</a></p>
      </div>
