          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                placeholder="Buscar equipo, provincia, capitán o teléfono"
                value={query}
...
function EditModal({
  ...
  async function submit(e: React.FormEvent) {
    ...
    if (!isValidSpanishProvince(province)) {
      setProvinceError('Elige una provincia de España de la lista');
      toast({ kind: 'error', title: 'Provincia no válida', desc: 'Debe ser una de las 50 provincias de España.' });
      return;
    }
